...
local timerFearCD				= mod:NewCDTimer(33, 74384, nil, nil, nil, 2)
...
function mod:OnCombatStart(delay)
    ...
    warnFearSoon:ScheduleVoice(14, "fearsoon") -- 3 secs prewarning
...
function mod:SPELL_CAST_START(args)
    if args.spellId == 74384 then
        specWarnFear:Show()
        warnFearSoon:ScheduleVoice(30, "fearsoon") -- 3 secs prewarning
        timerFearCD:Start()
    end
end
